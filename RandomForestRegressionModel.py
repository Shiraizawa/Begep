...
def random_forest_regression_model(train_df, test_df, n_estimators=100, max_depth=6, min_samples_leaf=2):
    ...
    random_forest_model = RandomForestRegressor(n_estimators=n_estimators, random_state=42, max_depth=max_depth, min_samples_leaf=min_samples_leaf)
